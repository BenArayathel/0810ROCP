...
public class Menu {
	...
	public Set<Items> presentMenuItems() {
		Set<Items> set_items = new HashSet<Items>();
		Items regular_coffee = new Items("Black Coffee", 1.99);
		set_items.add(regular_coffee);
		Items croissant = new Items("Croissant", 0.99);
		set_items.add(croissant);
		Items fruit = new Items("Fresh Fruit", 3.99);
		set_items.add(fruit);
		Items iced_coffee = new Items("Iced Coffee", 2.99);
		set_items.add(iced_coffee);
		return set_items;
	}
	...
	public void printOrder(Map<Items,Integer> order) {
	    ...
	    while (it.hasNext()) {
	        ...
	        Double count = inte.doubleValue();
	        Double t = count * i.getPrice();
	        total += t;
